# 18523-ingest-profiles-api-sample-create-custom-dynamic-delivery-profile
...
View the [documentation/working sample](https://support.brightcove.com/ingest-profiles-api-sample-create-custom-dynamic-delivery-profile).
